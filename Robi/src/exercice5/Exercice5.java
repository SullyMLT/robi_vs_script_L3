...
public class Exercice5 {
	...
	public class SetDim implements Command {
	    public Reference run(Reference ref, SNode methode) {
	        ...
	        // Si le receiver n'est ni un GSpace ni un GBounded, imprime un message d'erreur.
	            ...
	            System.err.println("Erreur: L'objet " + receiver.getClass().getName() + " ne peut pas ï¿½tre redimensionnï¿½.");
	        }
	...
	class Interpreter {
		public Reference compute(Environment env, SNode exp ){
			...
			if (refElm == null) {
			    System.err.println("Erreur : référence '" + exp.get(0).contents().toString() + "' introuvable.");
			    return null;
			}
