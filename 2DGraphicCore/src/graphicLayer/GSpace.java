...
public class GSpace extends JPanel implements GContainer, KeyListener, MouseListener {
	...
	public BufferedImage getBufferedImage() {
        // Création d'une BufferedImage de la même taille que GSpace
        BufferedImage image = new BufferedImage(this.getWidth(), this.getHeight(), BufferedImage.TYPE_INT_RGB);

        // Obtention du contexte graphique de l'image
        Graphics g = image.getGraphics();

        // Dessin du contenu de GSpace sur l'image
        // Cela peut impliquer de dessiner tous les éléments graphiques contenus dans GSpace
        this.paint(g);  // Vous devrez peut-être adapter cette ligne. Utilisez la méthode de GSpace qui dessine son contenu.
